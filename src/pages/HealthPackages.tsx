...
import HealthPackagesList from '@/components/packages/HealthPackagesList';
      ...
      <main className="flex-grow py-12 md:py-20 bg-gray-50/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-gray-800 mb-4">Health Check-up Packages</h1>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Choose from our curated health packages for a comprehensive overview of your health.
            </p>
          </div>
          <div className="mb-8 max-w-2xl mx-auto flex items-center gap-4">
            <div className="relative flex-grow">
              ...
              <Input
                type="text"
                placeholder="Search for a health package..."
                value={searchTerm}
          ...
          <HealthPackagesList searchTerm={searchTerm} />
        </div>
      </main>
      <Footer />
    </div>
